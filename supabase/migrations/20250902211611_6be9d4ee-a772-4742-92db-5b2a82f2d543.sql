...
-- Policy de UPDATE para OWNER (idempotente)
CREATE POLICY IF NOT EXISTS companies_owner_update
ON public.companies
FOR UPDATE
USING (
...
-- Drop genérico da constraint atual do subscription_status e recriação
-- =========================================
DO $$
DECLARE
  v_tbl oid;
